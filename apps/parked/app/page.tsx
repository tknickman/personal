...
function ParkedLandingPage() {
  const hostName = useHostName();

  useEffect(() => {
    if (hostName) {
      document.title = `Parked - ${hostName}`;
    }
  }, [hostName]);
      ...
      <main className={clsx("grid")}>
        <div className="mx-auto mt-2 max-w-lg text-center text-base text-gray-500 dark:text-gray-300">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
            If you found this site useful, please reach out to me below - I
            would love to hear from you. The original source has also been made
            available below.
          </p>
          <div className="mt-12">
            <Anchor
              ...
              href={
                hostName
                  ? `https://www.github.com/tknickman/${hostName}.com`
                  : undefined
              }
            >
              <CodeIcon
