          ...
          <div className="sm:ml-6">
            ...
            <div className="flex mt-10 space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              ...
              <a
                ...
                className="inline-flex items-center px-4 py-2 text-sm font-medium bg-white border border-transparent rounded-md text-primary-700 hover:bg-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
              >
                Get in Touch
              </a>
            </div>
